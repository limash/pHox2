...
from co3_instrument.components.interfaces import ILEDArray, ILightSource, IShutter
from co3_instrument.hardware.interfaces import IDigitalOutput, IPWMOutput
